...
export class InventoryController {
    ...
    static addInventory = async (req: Request, res: Response) => {
    ...
    static getBookInventory = async (req: Request, res: Response) => {
    ...
    static getLowStock = async (req: Request, res: Response) => {
